...
# %%
input_ids, loss_masks = tokenize_batch(wiki_dataset[0:2])

# %%
input_ids.shape, loss_masks.shape
...
class WikiTextDataset(Dataset):
    ...
    def __getitem__(self, idx):
        text = self.texts[idx]
        return text[0:1000] #500 to avoid long outliers causing OOM

# %%
train_dataset = WikiTextDataset(wiki_dataset[1000:10000])
